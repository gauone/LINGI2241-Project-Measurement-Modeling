...
*/
public class ServerNulthreadSkip {
     ...
     * @param portNumber
     */
    public ServerNulthreadSkip(int portNumber, int nMaxThreads, String dbFile) {
        ...
        public void searchLine(String request) {
            ...
            */
            ...
            try {
                ...
                for(int i = 0; i < this.dataTypes.size() && !breaked; i++) {                                         // For each line in Main memory
